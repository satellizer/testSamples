...
public class Bdb_TFlightDynamic {
    ...
    /* for index */
    private String flightNumber_date;
    private String cityCode_stopCityCode_date;

    // Constructors

    /** default constructor */
    public Bdb_TFlightDynamic() {
    }

    /** minimal constructor */
    public Bdb_TFlightDynamic(Long flightId) {
        this.flightId = flightId;
    }

    /** full constructor */
    public Bdb_TFlightDynamic(Long flightId, String airlineCode, String flightNumber, String cityCode, String cityCn, String cityEn,
            String stopCityCode, String stopCityCn, String stopCityEn, String planeType, Date planTime, Date predictTime, Date actualTime,
            String realtimeStatusCn, String realtimeStatusEn, String stopBuilding, Long isDomestic, Long isArrival, String checkinCounter,
            String gate, Date boardingTime, String sluiceGate, String baggageBelt, String flightType, String airlineCn, String airlineEn,
            Long isNormal, Long isPassengerPlane, Date flightTime) {
        this.flightId = flightId;
    ...
    public void setFlightNumber(String flightNumber) {
        ...
        if (null != this.planTime)
            this.flightNumber_date = flightNumber + this.planTime.toLocaleString();
    }
    ...
    public String getFlightNumber_date() {
        return flightNumber_date;
    }

    public void setFlightNumber_date(/* String flightNumber_date */) {
        // this.flightNumber_date = flightNumber_date;
        this.flightNumber_date = flightNumber + this.planTime.toLocaleString();
    }

    public String getCityCode_stopCityCode_date() {
        return cityCode_stopCityCode_date;
    }

    public void setCityCode_stopCityCode_date(String cityCode_stopCityCode_date) {
        if (null != cityCode_stopCityCode_date) {
            this.cityCode_stopCityCode_date = cityCode_stopCityCode_date;
            return;
        }
        this.cityCode_stopCityCode_date = this.cityCode + this.stopCityCode + this.planTime.toLocaleString();
    }
